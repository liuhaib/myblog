...
public class KuangCode {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/myblog_db?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.liuhaibin.myblog");
        pc.setEntity("pojo");
        pc.setMapper("mapper");
