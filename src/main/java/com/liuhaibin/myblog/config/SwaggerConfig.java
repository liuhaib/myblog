...
public class SwaggerConfig {
    ...
    public Docket restApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("标准接口")
                .apiInfo(apiInfo("Spring Boot中使用Swagger2构建RESTful APIs", "3.0"))
                .useDefaultResponseMessages(true)
                .forCodeGeneration(false)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.liuhaibin.myblog.controller"))
     ...
     * 访问地址：http://ip:port//swagger-ui/index.html   3.0地址
     *
     * @return
     */
